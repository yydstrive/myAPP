...
当前 Android 发布版本为 **1.1.1**（版本号 `111`）。

1.1.1 版本已启用新的手绘人物应用图标。

- **日程**：原有日程清单的全部页面和功能，包括日期任务、优先级、搜索、分类列表、逾期统计及回收站。
- **周期**：独立管理周期项目，主页支持周视图和月视图、今日快速打卡、项目排序，以及上次与预计下次日期；预计日期到期或逾期时会以亮橙色突出显示。详情页提供月历补签、打卡备注、取消打卡、全部历史、单次间隔和平均间隔，并可修改已有项目设置；历史日期经一次确认即可直接补签。新增与修改弹窗支持填写打卡说明，并提供煤气灶、电池、内裤、洗头、袜子、鼠标、汽车、爱心、玫瑰花和身份认证等内置图标。项目可设置按天或按月的可选周期间隔，并支持停用、恢复和永久删除。
